...
export const SOCIALS: Social[] = [{
    ...
    icon: {}
}, { name: "X"; href: "https://x.com/ahmed_d_alahmed"; linkTitle: "Ahmed Al Ahmed on X"; icon: {} }, {
    name: "LinkedIn";
...
export const SHARE_LINKS: Social[] = [{
    ...
    icon: {}
}, { name: "X"; href: "https://x.com/intent/post?url="; linkTitle: "Share this post on X"; icon: {} }, {
    name: "Telegram";
    ...
    icon: {}
}, { name: "Mail"; href: "mailto:?subject=See%20this%20post&body="; linkTitle: "Share this post via email"; icon: {} }] = [
  {
    name: "WhatsApp",
    href: "https://wa.me/?text=",
    linkTitle: `Share this post via WhatsApp`,
